...
export interface ApiHeroSlideHeroSlide extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AltAvatar: Schema.Attribute.String;
    AltMedia1: Schema.Attribute.String;
    AltMedia2: Schema.Attribute.String;
    AltMedia3: Schema.Attribute.String;
    ...
    Media3: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Concoction: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
